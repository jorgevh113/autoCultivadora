...
# a single instance of the sample (a quick burst of sound) and then silence for therest of the
...
audio.play(sine_wave_sample, loop=True) # Play the single sine_wave samplecontinuously...
